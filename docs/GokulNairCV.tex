...
\moveleft.5\hoffset\centerline{Rutgers University--New Brunswick}
	\moveleft.5\hoffset\centerline{gokul.nair@rutgers.edu}
...
\section{EMPLOYMENT}
\textbf{Postdoctoral Assistant Professor} \hfill Starting Jan 2026\\
Department of Mathematics, University of Michigan, Ann Arbor, MI, United States
Mentor: Ian Tobasco

\textbf{Hill Assistant Professor (postdoc)} \hfill Sep 2024 - Present\\	
Department of Mathematics, Rutgers University, NJ, United States\\
Mentor: Ian Tobasco

\section{EDUCATION}  
\textbf{Ph.D. in Applied Mathematics} \hfill Aug 2018 - Aug 2024\\
...
\textbf{Masters in Applied Mathematics} \hfill Aug 2018 - May 2021\\
Cornell University, Ithaca, NY, United States\\
Minors: Mathematics, Theoretical Physics
\smallskip

\textbf{Bachelor of Science in Physics} (First Class with Distinction) \hfill Aug 2014 - May 2018 \\
...
\textit{Scholarship encouraging undergraduates to take up research careers in science. Rank 87 nationwide.}

{\bf Duke of Edinburgh International Award Bronze,} (2012)\\
\textit{Encourages young people to engage in service, physical recreation, skills, and adventurous journeys.}

\section{RESEARCH\\PUBLICATIONS}
\begin{enumerate}
	\item {Scaling law analysis for frustrated assembly}, Gokul G. Nair, Ian Tobasco (in progress)
...
At Rutgers:
\begin{itemize}
	\item Calculus II, Instructor (Fall 2024)
	\item Multivariable calculus, Instructor (Fall 2024, Spring 2025, Fall 2025)
\end{itemize}
...
\section{TALKS}
\begin{itemize}
	\item \textbf{SIAM Conference on the Analysis of PDEs, Pittsburgh} \textit{Scaling law analysis for crystals on curved surfaces} (2025) *\textit{Invited talk}
	\item \textbf{AMS Sectional conference, St. Louis} \textit{Scaling law analysis for crystals on curved surfaces} (2025) *\textit{Invited talk}
	\item \textbf{Carnegie Mellon University, Frontiers of Applied Analysis workshop} \textit{Scaling law analysis for crystals on curved surfaces} (2025)
...
\begin{itemize}
	\item SIAM conference on Analysis of PDEs, Pittsburgh (2025)
	\item AMS Sectional conference, St. Louis (2025)
	\item Frontiers of Analysis workshop, Carnegie Mellon University (2025)
...
\section{SERVICE}
\begin{itemize}
	\item Reviewer for Letters in Mathematical Physics, Proceedings of the Royal Society A
